                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
                    ...
                    <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
                        ...
                        <div className="text-left">
                            ...
                            <button className="bg-sky-600 hover:bg-sky-700 text-white px-8 py-3 rounded-lg font-medium transition duration-200">
                    ...
                    <div className="lg:hidden flex flex-col min-h-[90vh] pt-8">
                        ...
                        <div className="text-center flex-1 flex flex-col justify-center px-2">
                            ...
                            <button className="bg-sky-600 hover:bg-sky-700 text-white px-6 py-3 rounded-lg font-medium transition duration-200 mx-auto">
                                Explore Our Solutions
                            </button>
                        </div>
                    </div>
