            ...
            <nav className={styles.nav}>
                <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <Link
                            href="/contact"
                            className={`border  ${scrolled || activeDropdown ? 'border-black' : 'border-white'}   ${scrolled || activeDropdown ? 'text-black' : 'text-white'} hover:text-white hover:border-white hover:bg-gradient-to-r from-[#525254] to-[#3564A4]  px-6 py-2 rounded-full font-medium transition duration-200`}
                        >
                            Contact
                        </Link>
                    </div>
            ...
            <div className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out md:hidden ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 border-t border-gray-200">
                        <Link
                            href="/contact"
                            className={`flex border bg-gradient-to-r from-[#525254] to-[#3564A4]  border-black text-white py-3 px-4 rounded-full justify-center items-center font-medium transition duration-300`}
                            onClick={closeMobileMenu}
                        >
                            Contact
                        </Link>
